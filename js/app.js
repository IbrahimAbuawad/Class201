...
let travelFunc = function(){let travel = prompt('Do you like to travel ( Yes / No ) ?');
...
let expensiveTravelFunc = function(){let expensiveTravel = prompt('DO you thing traveling expensive for you ( Yes / No ) ?');
...
let marriedFunc = function(){let married = prompt('Are you married ( Yes / No ) ?');
...
let pageRateFunc = function(){let pageRate = prompt('Do you want to give "5/5" rating this page ? ( Yes / No ) ');
...
let guessNumFunc = function(){let guessNumber;
...
let guessArrayFunc = function(){let guessMultipleNumber;
  let a;
  let attemptQ7 = 1;
  let arrayIndex = 0;
  for (a = 0; a < 6; a++) {
